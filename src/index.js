...
function createProjectDisplayButton() {
  ...
  projectDisplayButton.textContent = "Show Task's";
  ...
  projectDisplayButton.addEventListener("click", () => {
    ...
    if (todoList.style.display === "none") {
      ...
      projectDisplayButton.textContent = "Hide Task's";
    } else {
...
function createTodoDescription(description, project, index, todo) {
  ...
  // 💥💥 - Need to format the date generated by the form into something more human readable.
  todoDescription.classList.add("todo-description");
  todoDescription.innerHTML = `${description} <br> Due by ${dueDate}`;
  todoDescription.style.display = "none";
...
function handleTodoFormSubmit(event) {
  ...
  const selectedDate = document.getElementById("add-due-date").value;
  //✨✨✨
  const dueDate = dateFormat(selectedDate);
